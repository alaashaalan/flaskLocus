...
commands_tim = ['WIFI MODE 1', 'WIFI STASSID SHAW-65E920', 'WIFI STASECT WPA2_AES', 'WIFI STASECK 251169036894', 
'SYS WORKMODE 2', 'HTTP HOST 192.168.0.16', 'HTTP PORT 5000', 'HTTP URLPATH /intake', 'SYS REQINTVL 15', 
'HTTP KEEPALIVE 1', 'SYS GPRPWL 0000000000000000002F23 000000000000000000FFFF', 'NTP ENABLE 1',
'NTP SERVER pool.ntp.org', 'NTP SYNCINTVL 600', 'REBOOT 0']

for command in commands_tim:
	tn.write(command + "\n")
